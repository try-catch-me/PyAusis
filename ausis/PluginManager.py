...
import plugin
from core.GeneralUtilities import warning, error, executable_exists
...
class PluginManager(object):
    ...
    def __init__(self):
        ...
        self._backend.add_blacklisted_directories("ausis/packages/aiml")
        self._backend.add_blacklisted_directories("ausis/packages/memory")
