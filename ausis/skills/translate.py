...
@alias('trans')
@plugin('translate')
def translate(ausis, s):
    """
    Translates from one language to another and allows input to be somewhat natural.

    Usage:

    'ausis, please translate, from English to French, Hello, how are you?'

    OR

    'ausis, could you translate Hello, how are you? from English to French for me please?'
    """
