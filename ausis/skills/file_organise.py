...
class File_Organise():
    ...
    def __call__(self, ausis, s):
        self.file_manage(ausis)

    def source_path(self, ausis, dir_name):
        all_paths = []
    ...
    def file_manage(self, ausis):
        dir_name = ausis.input('Enter the name of directory you want to clear: ')
        dir_path = self.source_path(ausis, dir_name)
