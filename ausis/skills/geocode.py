...
class Geocoder:
    ...
    Attributes
    ----------
    Ausis : CmdInterpreter.AusisAPI
        An instance of ausis that will be used to interact with the user
    input_addr : str
    ...
    def __call__(self, ausis, s):
        ...
        self.ausis.say("Disclaimer: This product uses the Census Bureau Data"
        ...
        if not self.response:
            self.ausis.say("The geocoding service appears to be unavailable."
        ...
        # Request succeeded
            ...
            if self.output:
                for result in self.output:
                    self.ausis.say("{}: {}".format(result,
                                                    self.output[result]),
                                    Fore.CYAN)

            else:
                self.ausis.say("No matching addresses found.", Fore.RED)
    ...
    def help(self):
        ...
        self.ausis.say(self.help_prompt, Fore.BLUE)
    ...
    def get_input_addr(self, s):
        ...
        while True:
            if not s:
                s = self.ausis.input("Enter the full street address to"
