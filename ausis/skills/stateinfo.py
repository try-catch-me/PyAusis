    ...
    def __call__(self, ausis, s):
        ...
        if s:
            try:
                ...
                ausis.say("The capital of " + s.title() + " is " + capital)
                ausis.say("The postal abbreviation is " + abbreviation)
            except KeyError:
                ausis.say("Please enter a valid U.S. state")
        else:
            ausis.say("Please input a state. Usage: stateinfo [state]")
