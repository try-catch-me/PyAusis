import re
from core.GeneralUtilities import IS_MACOS, IS_WIN
import os
import subprocess
...
# class Voice:
#     """
#     ABOUT: This class is the Voice of ausis.
#         The methods included in this class
#         generate audio output of ausis while
...
class VoiceLinux():
    ...
    def text_to_speech(self, speech):
        ...
        :param speech: The text we want ausis to generate as audio
        :return: Nothing to return.
